...
namespace NewRelic.Agent.Core
{
    public static class LoggerBootstrapper
    {
        ...
        private static ILayout AuditLogLayout = new PatternLayout("%utcdate{yyyy-MM-dd HH:mm:ss,fff} NewRelic %level: %message%newline");
        private static ILayout FileLogLayout = new PatternLayout("%utcdate{yyyy-MM-dd HH:mm:ss,fff} NewRelic %6level: [pid: property{pid}, tid: property{threadid}] %message%newline");
